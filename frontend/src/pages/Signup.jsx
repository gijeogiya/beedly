...
export default function Signup() {
  ...
  const Join = () => {
    ...
    if (userName === "") {
      ...
      window.alert("생년월일를 입력해주세요");
    } else if (userNickname === "" || !isNicknameCheck) {
      ...
      <div style={SignupInput}>
        ...
        <div>
          <div style={flexrowbox}>
            ...
            {!isNicknameCheck && (
              <Button XsmallBlack onClick={CheckNickname} disabled="">
                중복검사
              </Button>
            )}
          </div>
        ...
        <div>
          <div style={flexrowbox}>
            ...
            <Button XsmallBlack onClick={handleComplete} disabled="">
              주소찾기
            </Button>
          </div>
          <div
            style={{
              backgroundColor: "rgba(31,29,29,0.1)",
              padding: "1px 10px",
            }}
          >
            <p
