    ...
    return (
        <FlexBox Column_SB style={{ height: "80vh" }}>
            <div style={{ margin: "0vh 3vh" }}>
                ...
                <p style={{ fontSize: "12px" }}>작가님은 추가 증빙 자료를 제출, 승인 후에 이용이 가능합니다.<br />
                    작가님 승인 이전에는 구매자 등급으로 이용이 가능합니다.<br />
                    dldkgus98@naver.com 으로 증빙 서류를 제출해주세요.</p>
            ...
            <br />
            <Button BigBlack onClick={SignupComplete}>다음</Button>
        </FlexBox>
    )
}
