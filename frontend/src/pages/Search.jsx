...
export default function SearchPage() {
    ...
    useEffect(() => {
        ...
        if (loading) {
            ...
            //최근 검색어 리스트 가져오기]
            if (localStorage.getItem("SearchList") !== null && localStorage.getItem("SearchList") !== undefined) {
    ...
    return (
        ...
        <div style={{ "padding-bottom": "20px" }}>
            ...
            <SizePickCardTable>
                <SizePickCard title={"Small Size"} size={"~70cm"} background_color={{ "backgroundColor": "#EBF0F5" }} onClick={(e) => SearchBySize("small")} />
                <SizePickCard title={"Medium Size"} size={"70cm~90cm"} background_color={{ "backgroundColor": "#F6EEED" }} onClick={(e) => SearchBySize("medium")} />
            </SizePickCardTable>
            <SizePickCardTable>
                <SizePickCard title={"Large Size"} size={"90cm~120cm"} background_color={{ "backgroundColor": "#F1F1EA" }} onClick={(e) => SearchBySize("large")} />
                <SizePickCard title={"XLarge Size"} size={"120cm~"} background_color={{ "backgroundColor": "#F5F5F5" }} onClick={(e) => SearchBySize("xlarge")} />
            </SizePickCardTable>
