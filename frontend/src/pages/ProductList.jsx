...
export default function ProductListPage() {
  ...
  return (
    <div>
      <nav>
          <StyledCategoryTable>
            <StyledCategoryButton onClick={ () => {  setloading(true);setNowCategory(prev => prev = '회화');  } } isActive={nowCategory ==='회화'}>회화</StyledCategoryButton>
            <StyledCategoryButton onClick={ () => { setloading(true); setNowCategory(prev => prev = '판화'); } } isActive={nowCategory ==='판화'}>판화</StyledCategoryButton>
            <StyledCategoryButton onClick={ () => { setloading(true); setNowCategory(prev => prev = '에디션'); } } isActive={nowCategory ==='에디션'}>에디션</StyledCategoryButton>
            <StyledCategoryButton onClick={ () => {  setloading(true);setNowCategory(prev => prev = '사진'); } } isActive={nowCategory ==='사진'}>사진</StyledCategoryButton>
            <StyledCategoryButton onClick={ () => { setloading(true); setNowCategory(prev => prev = '입체'); } } isActive={nowCategory ==='입체'}>입체</StyledCategoryButton>
          </StyledCategoryTable>
      </nav>
      <div style={{
