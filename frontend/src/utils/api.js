...
//카테고리로 상품 리스트 검색
const getOnairByCategoryApi = async (categoryName, page, size, sort, success, fail) => {
  await instance
    .get(`personalProduct/list/onAirByCategory?categoryName=${categoryName}&page=${page}&size=${size}&sort=${sort}`)
    .then(success)
    .catch(fail);
};
