    ...
    >
      ...
      >
        <StyledText
          size="16px"
          weight="700"
          text=" &lt; (주) 비들리 &gt;('www.Beedly.com'이하 'Beedly')은(는)
        ...
        제1조(개인정보의 처리 목적)
        <br />
        &lt; (주) 비들리 &gt;('www.Beedly.com'이하 'Beedly')은(는) 다음의 목적을
        ...
        보유근거 : 관련법령 관련법령 : 1)신용정보의 수집/처리 및 이용 등에 관한
        기록 : 3년 2) 소비자의 불만 또는 분쟁처리에 관한 기록 : 3년 3) 대금결제
        및 재화 등의 공급에 관한 기록 : 5년 4) 계약 또는 청약철회 등에 관한 기록
        : 5년 예외사유 :
        <br />
        ...
        <br />
        ② 제1항에 따른 권리 행사는(주) 비들리에 대해 「개인정보 보호법」 시행령
        제41조제1항에 따라 서면, 전자우편, 모사전송(FAX) 등을 통하여 하실 수
        있으며 (주) 비들리은(는) 이에 대해 지체 없이 조치하겠습니다.
        <br />
        ...
        <br />
        ⑥ (주) 비들리은(는) 정보주체 권리에 따른 열람의 요구, 정정·삭제의 요구,
        ...
        <br />
        ① &lt; (주) 비들리 &gt;은(는) 다음의 개인정보 항목을 처리하고 있습니다.
        <br />
        1&nbsp; &lt; 홈페이지 회원가입 및 관리 &gt; 필수항목 : 이메일, 비밀번호,
        로그인ID 선택항목 :
        <br />
        <br />
        제7조(개인정보의 파기)
        ...
        달리하여 보존합니다. 1. 법령 근거 : 2. 보존하는 개인정보 항목 :
        계좌정보, 거래날짜
        <br />
        ...
        있습니다.
        <br />
        2. 개인정보의 암호화 이용자의 개인정보는 비밀번호는 암호화 되어 저장 및
        ...
        ※ 개인정보 보호 담당부서로 연결됩니다.
        <br />
        ② 정보주체께서는 (주) 비들리 의 서비스(또는 사업)을 이용하시면서 발생한
        모든 개인정보 보호 관련 문의, 불만처리, 피해구제 등에 관한 사항을
        개인정보 보호책임자 및 담당부서로 문의하실 수 있습니다. (주) 비들리
        은(는) 정보주체의 문의에 대해 지체 없이 답변 및 처리해드릴 것입니다.
        <br />
        <br />
        제11조(개인정보 열람청구) 정보주체는 ｢개인정보 보호법｣ 제35조에 따른
        개인정보의 열람 청구를 아래의 부서에 할 수 있습니다. [(주) 비들리]은(는)
