...
const HeaderBox = ({ goBack }) => {
  return (
    <HeaderDiv>
      ...
      <StyledText size="20px" weight="bold" text="개인정보처리방침" />
...
export const PrivateTerms = ({ open, onDismiss }) => {
  return (
    <BottomSheet
      open={open}
      onDismiss={() => {
      ...
      >
        <p>
          <span style="font-size:16px; font-weight: 700;">
            &lt; (주) 비들리 &gt;('www.Beedly.com'이하 'Beedly')은(는)
          ...
          <br />
          <br />
          ○ 이 개인정보처리방침은 2022년 8월 18부터 적용됩니다.
          <br />
          <br />
          제1조(개인정보의 처리 목적)
          <br />
          &lt; (주) 비들리 &gt;('www.Beedly.com'이하 'Beedly')은(는) 다음의
          ...
          3. 재화 또는 서비스 제공
          <br />
          서비스 제공, 콘텐츠 제공, 맞춤서비스 제공, 본인인증, 연령인증,
          ...
          <br />
          ① &lt; (주) 비들리 &gt;은(는) 법령에 따른 개인정보 보유·이용기간 또는
          ...
          보유근거 : 관련법령 관련법령 : 1)신용정보의 수집/처리 및 이용 등에
          관한 기록 : 3년 2) 소비자의 불만 또는 분쟁처리에 관한 기록 : 3년 3)
          대금결제 및 재화 등의 공급에 관한 기록 : 5년 4) 계약 또는 청약철회
          등에 관한 기록 : 5년 예외사유 :
          <br />
          제5조(정보주체와 법정대리인의 권리·의무 및 그 행사방법)
          <br />
          ① 정보주체는 (주) 비들리에 대해 언제든지 개인정보
          열람·정정·삭제·처리정지 요구 등의 권리를 행사할 수 있습니다.
          <br />
          ② 제1항에 따른 권리 행사는(주) 비들리에 대해 「개인정보 보호법」
          시행령 제41조제1항에 따라 서면, 전자우편, 모사전송(FAX) 등을 통하여
          하실 수 있으며 (주) 비들리은(는) 이에 대해 지체 없이 조치하겠습니다.
          <br />
          ...
          <br />
          ⑥ (주) 비들리은(는) 정보주체 권리에 따른 열람의 요구, 정정·삭제의
          ...
          제7조(개인정보의 파기)
          <br />
          ① &lt; (주) 비들리 &gt; 은(는) 개인정보 보유기간의 경과, 처리목적 달성
          ...
          보관장소를 달리하여 보존합니다. 1. 법령 근거 : 2. 보존하는 개인정보
          항목 : 계좌정보, 거래날짜
          <br />
          ③ 개인정보 파기의 절차 및 방법은 다음과 같습니다.
          <br />
          1. 파기절차 &lt; (주) 비들리 &gt; 은(는) 파기 사유가 발생한 개인정보를
          선정하고, &lt; (주) 비들리 &gt; 의 개인정보 보호책임자의 승인을 받아
          개인정보를 파기합니다.
          <br />
          2. 파기방법
          <br />
          ...
          제10조 (개인정보 보호책임자)
          <br />
          ① (주) 비들리 은(는) 개인정보 처리에 관한 업무를 총괄해서 책임지고,
          개인정보 처리와 관련한 정보주체의 불만처리 및 피해구제 등을 위하여
          아래와 같이 개인정보 보호책임자를 지정하고 있습니다.
          <br />
          ※ 개인정보 보호 담당부서로 연결됩니다.
          <br />
          ② 정보주체께서는 (주) 비들리 의 서비스(또는 사업)을 이용하시면서
          발생한 모든 개인정보 보호 관련 문의, 불만처리, 피해구제 등에 관한
          사항을 개인정보 보호책임자 및 담당부서로 문의하실 수 있습니다. (주)
          비들리 은(는) 정보주체의 문의에 대해 지체 없이 답변 및 처리해드릴
          것입니다.
          <br />
          <br />
          제11조(개인정보 열람청구) 정보주체는 ｢개인정보 보호법｣ 제35조에 따른
          개인정보의 열람 청구를 아래의 부서에 할 수 있습니다. [(주)
          비들리]은(는) 정보주체의 개인정보 열람청구가 신속하게 처리되도록
          노력하겠습니다.
          <br />
          <br />
          제12조(권익침해 구제방법)
