...
예정된 경매 시작 시간 5분 전에 방 개설을 완료해주세요.
마지막 입찰자 이후 5분간 새로운 응찰이 없다면 경매가 자동으로 종료됩니다. 경매 종료 전 임의로 라이브 방송을 닫지 않도록 주의해주세요.
판매 작품은 비들리의 검수가 완료 된 후 구매자에게 전달됩니다. 구매자가 작품을 빠르게 받아볼 수 있도록, 판매 종료 24시간 내에 아래 주소로 작품 발송을 완료해주세요.보내실 주소서울특별시 강남구 테헤란로 212 멀티캠퍼스 역삼 1401 ㈜ 비들리(우: 06220) 물품 수령 담당자 앞Tel: 02-8336-7400배송 중 작품이 손상되지 않도록 포장에 유의해 주시길 바랍니다. 배송중 파손에 대한 책임은 판매자 본인에게 있습니다.
라이브 경매 중 불쾌한 언행을 하지 않도록 유의해 주세요. 해당 사례 적발 및 신고 접수 시 계정 정지 및 판매자 권한 박탈 처리 될 수 있습니다."
          />
        </TabPanel>
      </div>
    </BottomSheet>
