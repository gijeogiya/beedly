...
import { HorizonScrollRowTable, HorizonScrollColTable } from '../components/HorizonScrollTable'
...
export function MainPage() {
  return (
    <div>
      <CategoryBar />
      <BannerTable />
      <div style={{ "border-bottom": "1px solid #ebebeb", "padding-bottom": "20px", "padding-top": "20px" }}>
