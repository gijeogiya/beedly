package com.ssafy.beedly.dto.personal.product;
...
public class FavoriteProductDto {
    ...
    public FavoriteProductDto(PersonalFavorite personalFavorite) {
        PersonalProduct personalProduct = personalFavorite.getPersonalProduct();
...
//		this.artistImg = personalProduct.getArtist().getArtistBgImg();
        ...
        this.favoriteId = personalFavorite.getId();
    }
}
