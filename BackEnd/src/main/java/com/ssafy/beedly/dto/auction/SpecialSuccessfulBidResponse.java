...
@AllArgsConstructor
@NoArgsConstructor
public class SpecialSuccessfulBidResponse {
    ...
    @ApiModelProperty(notes = "다음 기획전 상품 인덱스 번호")
    private Integer nextSProdIdx;

    public SpecialSuccessfulBidResponse(SpecialSold ss, Integer nextSProdIdx) {
        ...
        this.nextSProdIdx = nextSProdIdx;
    }
}
